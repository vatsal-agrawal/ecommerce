                        ...
                        <div class="cheque">
                            ...
                            <div class="logos">
                                <a href="#" class="logos-item">
                                    <img src="/ecommerce/public/app/img/visa.png" alt="Visa">
                                </a>
                                <a href="#" class="logos-item">
                                    <img src="/ecommerce/public/app/img/mastercard.png" alt="MasterCard">
                                </a>
                                <a href="#" class="logos-item">
                                    <img src="/ecommerce/public/app/img/discover.png" alt="DISCOVER">
                                </a>
                                <a href="#" class="logos-item">
                                    <img src="/ecommerce/public/app/img/amex.png" alt="Amex">
                                </a>
                                ...
                                <span style="float: right;">
                                    <form action="{{route('cart.pay')}}" method="POST">
                                        ...
                                        <script
                                          ...
                                          data-key="--public test key--"
                                          data-amount= {{Cart::total() * 100}}
                                          data-name="SEO Marketing Strategy"
