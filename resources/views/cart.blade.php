                                ...
                                <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            ...
                                            <div class="cart-product__item">
                                                <a href="#">
                                                    {{--  {{dd($product->product->file_id)}}  --}}
                                                    {{--  <h5 class="cart-product-title">{{$product->model->file->file}}</h5>  --}}
                                                    <img src="images/{{$product->model->file->file}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                </a>
                                                <br>
